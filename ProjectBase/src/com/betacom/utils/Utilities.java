...
public class Utilities {
	...
	public static LocalDate stringToDate(String pattern, String myDate) throws DateTimeParseException, AcademyException {
		LocalDate r = null;
		try {
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern(pattern, Locale.ITALIAN);
			...
			throw new AcademyException("Formato data invalita");
		}
